...
import com.example.fyp_ippt_connect_android.BluefruitApplication;
...
public class MainActivity extends AppCompatActivity implements ScannerFragment.ScannerFragmentListener{
    ...
    private boolean manageLocationServiceAvailabilityForScanning() {
        ...
        // Location services are only needed to be enabled from Android 6.0
    ...
    public void startPeripheralModules(String peripheralIdentifier) {
        ...
        PeripheralModulesPagerFragment fragment = PeripheralModulesPagerFragment.newInstance(peripheralIdentifier);
        FragmentManager fragmentManager = getSupportFragmentManager();
