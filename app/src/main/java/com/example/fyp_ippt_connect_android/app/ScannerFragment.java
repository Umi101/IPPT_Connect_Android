...
import com.example.fyp_ippt_connect_android.ble.central.BleManager;
import com.example.fyp_ippt_connect_android.ble.central.BlePeripheral;
//import com.example.fyp_ippt_connect_android.dfu.ReleasesParser;
//import com.example.fyp_ippt_connect_android.models.DfuViewModel;
import com.example.fyp_ippt_connect_android.models.ScannerViewModel;
import com.example.fyp_ippt_connect_android.style.StyledSnackBar;
...
public class ScannerFragment extends Fragment implements ScannerStatusFragmentDialog.onScannerStatusCancelListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mScannerViewModel.getBlePeripheralDiscoveredServices().observe(getViewLifecycleOwner(), blePeripheral -> {
            if(blePeripheral != null){
                switchToPeripheral(blePeripheral);
            }
            else{
                Log.d(TAG, "null ble");
            }
...
//            mConnectingDialog.cancel();
    ...
    @MainThread
    private void switchToPeripheral(BlePeripheral blePeripheral){
        removeConnectionStateDialog();
