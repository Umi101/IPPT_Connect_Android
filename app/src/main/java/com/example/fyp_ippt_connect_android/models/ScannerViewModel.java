package com.example.fyp_ippt_connect_android.models;
...
import com.example.fyp_ippt_connect_android.utils.SingleLiveEvent;
...
public class ScannerViewModel extends AndroidViewModel implements BleScanner.BleScannerListener {
    ...
    public LiveData<BlePeripheral> getBlePeripheralDiscoveredServices2() {
        return mBlePeripheralDiscoveredServices;
    }
